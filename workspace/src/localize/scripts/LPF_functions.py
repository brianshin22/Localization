...
#-----------------------------------------------------------------------------
    ...
    # if right lane measurement is good enough, update corresponding probability vector
    ...
    # if left lane measurement is good enough, update corresponding probability vector
...
def LPF_main(iter_num, dt, num_particles, GPS_available, \
